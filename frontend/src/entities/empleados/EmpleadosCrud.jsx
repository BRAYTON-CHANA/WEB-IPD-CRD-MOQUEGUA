...
/**
 * EmpleadosCrud — Componente CRUD pre-armado para EMPLEADOS.
 ...
 */
function EmpleadosCrud({ config = {}, headerOverrides = {}, tableOverrides = {} }) {
  ...
  const headerProps = {
    ...
    actions: [
      {
        text: mergedConfig.headerProps?.createButtonText || 'Registrar Empleado',
